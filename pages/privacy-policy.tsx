...
export default function BlogPost() {
  ...
  return (
    <Blog postMeta={meta.privacyPolicy} posts={[]}>
      ...
      This is all we are now doing. We could integrate a Rest API or run ads in
      the future. In addition, there could be some kind of payment. In any case,
      ...
      have.
      <H level={2} callback={callback} text="Legal Stuff" />
      ...
      <H level={2} callback={callback} text="Privacy Policy" />
      ...
      “Service”). Our Privacy Policy governs your visit to https://avif.io &
      https://avif.io and https://avif.io and https://avif.io and possibly an
      avif.io mobile application, and explains how we collect, safeguard and
      ...
      <H level={2} callback={callback} text="Definitions" />
      ...
      of a page visit). COOKIES are small files stored on your device (computer
      ...
      Controller of your data. DATA PROCESSORS (OR SERVICE PROVIDERS) means any
      ...
      to process your data more effectively. DATA SUBJECT is any living
      ...
      <H callback={callback} level={2} text="Information Collection and Use" />
      We collect several different types of information for various purposes to
      provide and improve our Service to you.
      <H level={2} callback={callback} text="Types of Data Collected" />
      ...
      include, but is not limited to: (a) Email address (b) First name and last
      name (c) Cookies and Usage Data We may use your Personal Data to contact
      ...
      any, or all, of these communications from us by emailing at
      ...
      diagnostic data. Location Data We may use and store information about your
      location if you give us permission to do so (“Location Data”). We use this
      ...
      Service at any time by way of your device settings. Tracking Cookies Data
      ...
      Other tracking technologies are also used such as beacons, tags and
      ...
      of Cookies we use: (a) Session Cookies: We use Session Cookies to operate
      our Service. (b) Preference Cookies: We use Preference Cookies to remember
      your preferences and various settings. (c) Security Cookies: We use
      ...
      <H level={2} callback={callback} text="Use of Data" />
      ...
      you choose to do so; (d) to provide customer support; (e) to gather
      analysis or valuable information so that we can improve our Service; (f)
      to monitor the usage of our Service; (g) to detect, prevent and address
      technical issues; (h) to fulfill any other purpose for which you provide
      it; (i) to carry out our obligations and enforce our rights arising from
      any contracts entered into between you and us, including for billing and
      collection; (j) to provide you with notices about your account and/or
      subscription, including expiration and renewal notices,
      email-instructions, etc.; (k) to provide you with news, special offers and
      ...
      <H level={2} callback={callback} text="Retention of Data" />
      ...
      time periods.
      <H level={2} callback={callback} text="Transfer of Data" />
      ...
      differ from those of your jurisdiction. If you are located outside United
      ...
      of such information represents your agreement to that transfer. avif.io
      will take all the steps reasonably necessary to ensure that your data is
      ...
      <H level={2} callback={callback} text="Disclosure of Data" />
      ...
      response to valid requests by public authorities. (b) Business
      Transaction. If we or our subsidiaries are involved in a merger,
      acquisition or asset sale, your Personal Data may be transferred. (c)
      Other cases. We may disclose your information also: (i) to our
      subsidiaries and affiliates; (ii) to contractors, service providers, and
      other third parties we use to support our business; (iii) to fulfill the
      purpose for which you provide it; (iv) for the purpose of including your
      company’s logo on our website; (v) for any other purpose disclosed by us
      when you provide the information; (vi) with your consent in any other
      ...
      others.
      <H level={2} callback={callback} text="Security of Data" />
      ...
      See more at https://eur-lex.europa.eu/eli/reg/2016/679/oj We aim to take
      reasonable steps to allow you to correct, amend, delete, or limit the use
      of your Personal Data. If you wish to be informed what Personal Data we
      hold about you and if you want it to be removed from our systems, please
      email us at support@avif.io. In certain circumstances, you have the
      following data protection rights: (a) the right to access, update or to
      delete the information we have on you; (b) the right of rectification. You
      have the right to have your information rectified if that information is
      inaccurate or incomplete; (c) the right to object. You have the right to
      object to our processing of your Personal Data; (d) the right of
      restriction. You have the right to request that we restrict the processing
      of your personal information; (e) the right to data portability. You have
      the right to be provided with a copy of your Personal Data in a
      structured, machine-readable and commonly used format; (f) the right to
      withdraw consent. You also have the right to withdraw your consent at any
      ...
      some necessary data. You have the right to complain to a Data Protection
      ...
      According to CalOPPA we agree to the following: (a) users can visit our
      site anonymously; (b) our Privacy Policy link includes the word “Privacy”,
      and can easily be found on the page specified above on the home page of
      our website; (c) users will be notified of any privacy policy changes on
      our Privacy Policy Blog; (d) users are able to change their personal
      information by emailing us at support@avif.io. Our Policy on “Do Not
      Track” Signals: We honor Do Not Track signals and do not track, plant
      cookies, or use advertising when a Do Not Track browser mechanism is in
      place. Do Not Track is a preference you can set in your web browser to
      inform websites that you do not want to be tracked. You can enable or
      disable Do Not Track by visiting the Preferences or Settings page of your
      web browser.
      <H
        level={2}
        text="Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)"
      ...
      ask us: (a) What personal information we have about you. If you make this
      request, we will return to you: (i) The categories of personal information
      we have collected about you. (ii) The categories of sources from which we
      collect your personal information. (iii) The business or commercial
      purpose for collecting or selling your personal information. (iv) The
      categories of third parties with whom we share personal information. (v)
      ...
      your personal information, we will inform you of that fact. (vii) A list
      ...
      it with. Please note, you are entitled to ask us to provide you with this
      ...
      information we collected about you in the previous 12 months. (b) To
      ...
      which require the usage of your personal information to function. But in
      no circumstances, we will discriminate against you for exercising your
      rights. To exercise your California data protection rights described
      above, please send your request(s) by one of the following means: By
      email: support@avif.io Your data protection rights, described above, are
      ...
      <H level={2} callback={callback} text="Service Providers" />
      ...
      <H level={2} callback={callback} text="Analytics" />
      ...
      overall trends in our website traffic, it is not to track individual
      visitors. All the data is in aggregate only. No personal data is
      collected. You can view the data we collect in our live demo. Data
      collected includes referral sources, top pages, visit duration,
      ...
      data policy.
      <H level={2} callback={callback} text="Hotjar" />
      ...
      <H level={2} callback={callback} text=" CI and CD Tools" />
      ...
      build software. For more information on what data GitHub collects for what
      purpose and how the protection of the data is ensured, please visit GitHub
      Privacy Policy page:
      https://help.github.com/en/articles/github-privacy-statement. GitLab CI/CD
      GitLab CI/CD is provided by GitLab, Inc. GitLab CI (Continuous
      Integration) service is a part of GitLab that build and test the software
      whenever developer pushes code to application. GitLab CD (Continuous
      Deployment) is a software service that places the changes of every code in
      the production which results in every day deployment of production. For
      ...
      <H level={2} callback={callback} text="Advertising" />
      ...
      web page: https://google.com/ads/preferences/ Bing Ads Bing Ads is an
      advertising service provided by Microsoft Inc. You can opt-out from Bing
      Ads by following the instructions on Bing Ads Opt-out page:
      https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads
      For more information about Bing Ads, please visit their Privacy Policy:
      https://privacy.microsoft.com/en-us/PrivacyStatement AdMob by Google AdMob
      by Google is provided by Google Inc. You can opt-out from the AdMob by
      ...
      <H level={2} callback={callback} text="Behavioral Remarketing" />
      ...
      Service. Google Ads (AdWords) Google Ads (AdWords) remarketing service is
      provided by Google Inc. You can opt-out of Google Analytics for Display
      Advertising and customize the Google Display Network ads by visiting the
      Google Ads Settings page: https://google.com/settings/ads Google also
      ...
      Bing Ads Remarketing Bing Ads remarketing service is provided by Microsoft
      Inc. You can opt-out of Bing Ads interest-based ads by following their
      instructions:
      https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads
      ...
      by the Digital Advertising Alliance. You can also opt-out from Facebook
      and other participating companies through the Digital Advertising Alliance
      in the USA https://aboutads.info/choices/, the Digital Advertising
      Alliance of Canada in Canada https://youradchoices.ca/ or the European
      ...
      <H level={2} callback={callback} text="Payments" />
      ...
      payment processors we work with are: PayPal or Braintree: Their Privacy
      Policy can be viewed at https://paypal.com/webapps/mpp/ua/privacy-full
      FastSpring: Their Privacy Policy can be viewed at
      https://fastspring.com/privacy/ Apple Store In-App Payments: Their Privacy
      Policy can be viewed at: https://apple.com/legal/privacy/en-ww/ /
      https://support.apple.com/en-us/HT203027 Google Play In-App Payments:
      ...
      https://stripe.com/us/privacy 2Checkout: Their Privacy Policy can be
      viewed at: https://2checkout.com/legal/privacy/ Adyen: Their Terms and
      conditions can be viewed at https://adyen.com/legal/terms-and-conditions.
      Alipay: Their Privacy Policy can be viewed at:
      https://render.alipay.com/p/f/agreementpages/alipayglobalprivacypolicy.html
      Authorize.net: Their Privacy Policy can be viewed at:
      https://authorize.net/about-us/privacy/ Elavon: Their Privacy Policy can
      be viewed at: https://elavon.com/privacy-pledge.html First Data: Their
      Privacy Policy can be viewed at: https://firstdata.com/en_us/privacy.html
      Go Cardless: Their Privacy Policy can be viewed at:
      https://gocardless.com/legal/privacy Klarna: Their Services Terms, Privacy
      Policy and Buyer Protection Policy can be viewed at
      https://klarna.com/us/legal/. Moneris: Their Privacy Policy can be viewed
      at: https://moneris.com/legal/privacy-policy Plaid: Their End User Privacy
      Policy, Cookie Policy and Privacy Statement can be viewed at
      https://plaid.com/legal/. Sage Pay: Their Privacy Policy can be viewed at:
      https://sagepay.co.uk/policies/privacy-policy Square: Their Privacy Policy
      can be viewed at: https://squareup.com/us/en/legal/general/privacy
      Verifone: Their Privacy Policy can be viewed at:
      https://verifone.com/en/privacy WePay: Their Privacy Policy can be viewed
      ...
      <H level={2} callback={callback} text="Links to other sites" />
      ...
      services.
      <H level={2} callback={callback} text="Children's Privacy" />
      ...
      a Child has provided us with Personal Data, please contact us. If we
      ...
      from our servers.
      <H callback={callback} level={2} text="Changes to this Privacy Policy" />
      ...
      <H level={2} callback={callback} text="Contact Us" />
