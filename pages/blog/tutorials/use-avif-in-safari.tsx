...
export default function BlogPost() {
  ...
  return (
    <Blog postMeta={meta.tutSafari} posts={[meta.tutHtml, meta.tutFirefox, meta.tutEdge]}>
      ...
      <H level={2} contentTableCallback={contentTableCallback} text="Safari AVIF support soon" />
      ...
      future patch.
      <H level={2} contentTableCallback={contentTableCallback} text="Even ANIMATED support!" />
