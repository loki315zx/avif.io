...
export default function BlogPost() {
  ...
  return (
    ...
    >
      ...
      answer is simple:{" "}
      <b>Most Javascript front-end frameworks support AVIF natively</b> and rely
      on HTML and CSS implementation. To make sure we are not talking nonsense,
      we tested it with the following frameworks:
      <Checklist
        items={[
          "facebook/react",
          "vuejs/vue",
      ...
      live, we list it here as "maybe works" until we were in the science lab.
      <Checklist
        items={[
          "meteor/meteor",
          "jashkenas/backbone",
      ...
      Simply add the detection for AVIF files to the fileloader in your
      webpack.config.js:
  ...
  module: {
    rules: [{
      ...
      you ever encountered such a plugin? Have you had any good or bad
