...
export default function BlogPost() {
  ...
  return (
    <Blog postdata={postdata} posts={[post1, post2, post3]}>
      ...
      video coding. Mozilla has announced that current AVIF image support is complete.
      <br /> Also, they claim previously encountered problems with the format have been resolved.
      There was a Mozilla bug ticket tracking the default support of AVIF. The patch enabling
      default support has initially been pushed but reverted as a result of broken tests. Those
      items have been reviewed and AVIF appears to be ready to land now. In any case, Firefox will
      ...
      interested in adding support may do so at the time of writing. When enabled,{" "}
      <b>Firefox will render AVIF image files just like any other image format</b> supported by the
      ...
      with the about:config configurations. Type <b>about:config</b> inside the address bar and
      press Enter.
      ...
      page, search for avif. The option <b>image.avif.enabled</b> is the one you are looking for. If
      the second column's value is showing 'false', click the right switch button to set it to true.
      A 'true' value means that Firefox supports AVIF, whereas a 'false' value means the browser's
