...
export default function BlogAvif() {
  return (
    <Blog postdata={postdata} posts={posts}>
      ...
      May 2019 Update. Windows 10 does not natively support the AVIF image format but it appears
      that the software giant is exploring new ways to incorporate this functionality into the core
      applications, and more specifically the File Explorer and Paint. As long as you have the
      proper AV1 video codec installed from the Microsoft Store on your computer, you will be able
      to view AVIF images natively within Windows 10 apps such as Paint and File Explorer.
      ...
      default, or take a look at this:
      https://www.microsoft.com/de-de/p/av1-video-extension/9mvzqvxjbq9v?activetab=pivot:overviewtab
      The AV1 extension has been around since Windows 10's version 1809, which is where support for
      the AV1 video format first appeared. Since version 1903, however, the extension can now also
      handle AVIF files.
      ...
      order to work on image files like AVIF. You can look into our articles on GIMP for more
      details on that.
    </Blog>
  );
}
