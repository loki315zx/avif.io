...
export default function BlogPost() {
  ...
  return (
    <Blog postdata={postdata} posts={[post1, post2, post3]}>
      ...
      is now capable of supporting the AVIF image format natively, which means that you can import
      and export AV1-based AVIF images as you would any other supported format.
      ...
      possible options.
      <br /> First, you will have the option to select the degree to which you want to preserve the
      quality of the image. We recommend a value above 20 and give you a more detailed comparison
      below this text. In addition, you can adjust the bit depth of the image. You can choose
      between 8, 10 or 12 bits per channel. The higher the bit depth, the greater the number of
      colors stored in your image. By way of comparison, JPG has 8 bits. So if you are not a
