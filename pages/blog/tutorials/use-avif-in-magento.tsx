...
export default function BlogPost() {
  ...
  return (
    <Blog postMeta={meta} posts={[post1, post2, post3]}>
      ...
      <br /> New image formats are always under scrutiny. But either they are not helpful or they
      ...
      automatic AVIF conversion, <b>WebP images and original images are available as a fallback</b>.
      ...
      module, which replaces JPG and PNG images with smaller WebP images.
      <br /> Interestingly, he is excited to{" "}
      <b>support other next-generation image formats such as JPEG XL and WebP2 in the future</b>.
      This enthusiasm has also led him to merge his existing WebP module with the theoretical AVIF
