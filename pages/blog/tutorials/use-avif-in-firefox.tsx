...
export default function BlogPost() {
  ...
  return (
    ...
    >
      ...
      <H level={2} callback={callback} text="Update March 2021" />
      ...
      <H level={2} callback={callback} text="Update January 2021" />
      ...
      <H level={2} callback={callback} text="Update December 2020" />
      ...
      <H level={2} callback={callback} text="Original Post" />
      ...
      integrate AVIF too.
      <H level={2} callback={callback} text="Check your version" />
      ...
      <H callback={callback} level={2} text="Enable AVIF support in Firefox" />
