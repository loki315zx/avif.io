...
import {
  useAvifInCloudflare as postdata,
...
export default function BlogPost() {
  ...
  return (
    <Blog postdata={postdata} posts={[post1, post2, post3]}>
      ...
      <br />
      On October 3, Cloudflare announced support for automatic AVIF image delivery. If we check web
      statistics, we can see that more than half of an average website size is occupied by images.
      We can also see that about <b>15% of websites are powered by Cloudflare</b>, which gives
      ...
      the web faster. Improved image compression{" "}
      <b>can reduce bandwidth usage and improve web performance</b>. Services and companies like
      Discord, ILovePDF, Hubspot and Zendesk all use the technology provided by Cloudflare to
      function. We assume that you are on this page because you are using Cloudflare services and
      want to know how to turn on AVIF support. Oh, and by the way, this post is not sponsored in
      any way. Let's see:
      <H
      ...
      that automatically converting your images into the best variant for your users{" "}
      <b>will eventually be part of their Pro plans in the future</b>. <br /> Pro Plans start at $20
      per month and have a lot more features. Automatic selection of the best TCP settings,
  ...
  event.respondWith(fetch(imageURL), {cf:{image: resizingOptions}})
    ...
    <img src="/image.jpg">
      ...
      Apple for Safari have confirmed integration. Please do not hesitate to look at the sources
      below for additional information about Cloudflare and their AVIF support.
      <br />
