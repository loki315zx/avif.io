...
export default function BlogPost() {
  ...
  return (
    <Blog className="release" postdata={postdata} posts={[post1, post2, post3]}>
      ...
      improving its AVIF encoder, rav1e. The Xiph Foundation claims rav1e is the safest and fastest
      AVIF encoder online. The company always updates its code which proves its ability to speed up
      the conversion process every time. We are glad to announce, that we successfully implemented
      ...
      some severe issues with Safari. However, all of these issues are now fixed. If you still
